...
public class SpecialitySearchCommand : CommandBase
{
    ...
    public SpecialitySearchCommand(DoctorPickViewModel viewModel, IDoctorService doctorService)
    {
    ...
    {
        _viewModel.Doctors = _doctorService.SearchBySpeciality(_viewModel.SearchTerm);
        _viewModel.LoadRows();
    }
}